...
// GetVolume POSTs to /shares/{share-id}
func (vs *VolumeFileService) GetVolume(volumeID string, ctxLogger *zap.Logger) (*models.Volume, error) {
...
// GetVolumeByName GETs /shares
func (vs *VolumeFileService) GetVolumeByName(volumeName string, ctxLogger *zap.Logger) (*models.Volume, error) {
